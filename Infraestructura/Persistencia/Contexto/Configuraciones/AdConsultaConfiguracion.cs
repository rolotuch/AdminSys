...
{
    public class AdConsultaConfiguracion : IEntityTypeConfiguration<AdConsulta>
    {
        public void Configure(EntityTypeBuilder<AdConsulta> builder)
        {
            builder.HasKey(e => new { e.Objeto, e.Alias });

            builder.ToTable("AD_CONSULTAS");
            ...
            builder.Property(e => e.SelectStatementAux)
                .HasColumnType("CLOB")
