...
{
    public class AdColumnaConfiguracion : IEntityTypeConfiguration<AdColumna>
    {
        public void Configure(EntityTypeBuilder<AdColumna> builder)
        {
            builder.HasKey(e => new { e.Objeto, e.Alias, e.Datafield });

            builder.ToTable("AD_COLUMNAS");

            builder.HasIndex(e => new { e.Objeto, e.Alias }, "IX_AD_COLUMNAS");

            builder.HasIndex(e => e.Objeto, "IX_AD_COLUMNAS_1");

            builder.HasIndex(e => e.Datafield, "IX_AD_COLUMNAS_2");
