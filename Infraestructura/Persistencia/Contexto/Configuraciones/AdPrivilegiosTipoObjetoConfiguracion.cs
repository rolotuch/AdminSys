...
{
    public class AdPrivilegiosTipoObjetoConfiguracion : IEntityTypeConfiguration<AdPrivilegiosTipoObjeto>
    {
        public void Configure(EntityTypeBuilder<AdPrivilegiosTipoObjeto> builder)
        {
            builder
                .HasNoKey()
