...
{
    public class AdOperacionesRestrictivaConfiguracion : IEntityTypeConfiguration<AdOperacionesRestrictiva>
    {
        public void Configure(EntityTypeBuilder<AdOperacionesRestrictiva> builder)
        {
            builder
                .HasNoKey()
