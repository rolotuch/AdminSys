...
{
    public class AdTempoConsultaConfiguracion : IEntityTypeConfiguration<AdTempoConsulta>
    {
        public void Configure(EntityTypeBuilder<AdTempoConsulta> builder)
        {
            builder.HasKey(e => new { e.Objeto, e.Alias });

            builder.ToTable("AD_TEMPO_CONSULTAS");
