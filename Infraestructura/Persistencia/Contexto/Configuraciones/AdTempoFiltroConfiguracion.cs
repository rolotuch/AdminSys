...
{
    public class AdTempoFiltroConfiguracion : IEntityTypeConfiguration<AdTempoFiltro>
    {
        public void Configure(EntityTypeBuilder<AdTempoFiltro> builder)
        {
            builder.HasKey(e => new { e.Objeto, e.Campo });

            builder.ToTable("AD_TEMPO_FILTROS");
